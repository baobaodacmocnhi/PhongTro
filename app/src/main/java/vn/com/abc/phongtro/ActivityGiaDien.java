    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSua.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    {
                        Toast.makeText(ActivityGiaDien.this, "Chưa chọn Phòng", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    EditText txtName = (EditText) findViewById(R.id.txtName);
                    EditText txtGiaTien = (EditText) findViewById(R.id.txtGiaTien);
                    String resp = ws.SuaGiaDien(txtID.getText().toString(),txtName.getText().toString(), txtGiaTien.getText().toString());
                    Toast.makeText(ActivityGiaDien.this, resp.toString(), Toast.LENGTH_SHORT).show();
                    onStart();
                } catch (Exception ex) {
                    Toast.makeText(ActivityGiaDien.this, ex.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (tbGiaDien != null) {
                    for (int i = 0; i < tbGiaDien.getPropertyCount(); i++) {
                        SoapObject obj = (SoapObject) tbGiaDien.getProperty(i);
